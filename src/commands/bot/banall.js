...
module.exports = {
    ...
    async execute(bot, message, parts) {
        if(!message.guild.me.permissions.has(Permissions.FLAGS.BAN_MEMBERS)) return console.log(`${`[ERROR]`.red} Missing Permission 'BAN_MEMBERS' on Guild ${message.guild.name}!`)
